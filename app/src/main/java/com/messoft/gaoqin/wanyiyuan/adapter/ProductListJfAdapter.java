...
import com.messoft.gaoqin.wanyiyuan.databinding.ItemJfProductBinding;
 ...
 * 商品列表 积分
 */
public class ProductListJfAdapter extends BaseRecyclerViewAdapter<ProductInfo> {

    private Context mContext;

    public ProductListJfAdapter(Context context) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        return new ViewHolder(parent, R.layout.item_jf_product);
    }


    class ViewHolder extends BaseRecyclerViewHolder<ProductInfo, ItemJfProductBinding> {
