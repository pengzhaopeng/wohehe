package com.messoft.gaoqin.wanyiyuan.base.baseadapter;
...
public abstract class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    @Override
    public void onBindViewHolder(BaseRecyclerViewHolder holder, @SuppressLint("RecyclerView") final int position) {
