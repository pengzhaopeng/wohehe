...
//    private String errorMsg = "未知的错误！";
    ...
    private final int tokenInvalid = 999;
...
//            onSuccess(t,message);
            ...
            if (value.getState() == tokenInvalid) {
                //TODO Token 失效
                ToastUtil.showShortToast("账号过期，请重新登录");
...
//            case 997: //秘钥不存在
//            case 998: //请求地址失效
            case tokenInvalid: //TODO token已失效请重新登录
                //退回到登录页面
...
//                }
    ...
    private final void getErrorMsg(HttpException httpException) {
        ...
        try {      //我们的项目需要的UniCode转码
            errorBodyStr = com.messoft.gaoqin.wanyiyuan.utils.StringUtils.toURLEncoderUTF8(httpException.response().errorBody().string());
