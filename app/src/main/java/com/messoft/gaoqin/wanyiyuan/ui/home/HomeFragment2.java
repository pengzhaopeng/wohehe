...
import com.messoft.gaoqin.wanyiyuan.databinding.FragmentHome2Binding;
...
public class HomeFragment2 extends BaseFragment<FragmentHome2Binding> {
    ...
    protected void initListener() {
        ...
        //互销区
        bindingView.ll1.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                SysUtils.startActivity(getActivity(), HxqActivity.class);
            }
        });
        //预约抢购
        bindingView.ll2.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                SysUtils.startActivity(getActivity(), YyqgListActivity.class);
            }
        });
        //积分商城
        bindingView.ll5.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                SysUtils.startActivity(getActivity(), JfscActivity.class);
            }
        });
        //生活必备
        bindingView.ll6.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                SysUtils.startActivity(getActivity(), ShbbActivity.class);
            }
        });
        //线下店
        bindingView.ll4.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                String urlCarCheck = "http://ace-o2o.ace100.com/www?bind_account=" + BusinessUtils.getAccount() + "&openid=";
                WebActivity.loadUrl(getActivity(), urlCarCheck);

            }
        });
        //会员专区
        bindingView.ivHyzq.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                SysUtils.startActivity(getActivity(), HyzqActivity.class);
            }
        });
    }
    ...
    protected void loadData() {
        ...
        synchronized (this) {
            if (bindingView.refreshLayout != null){
...
//    }
    ...
    private void loadProductList() {
        if (mId == null) return;
        mProductModel.getProductList(getBaseActivity(), null, mId, "1", "0", null,
