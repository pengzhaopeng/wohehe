...
import com.messoft.gaoqin.wanyiyuan.databinding.ActivityWoYaoShouMaiBinding;
...
import com.messoft.gaoqin.wanyiyuan.ui.my.BlankCardActivity;
 ...
 * 我要售卖
 */
public class WoYaoShouMaiActivity extends BaseActivity<ActivityWoYaoShouMaiBinding> {
...
//    private String mMobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wo_yao_shou_mai);
    }
    ...
    protected void initSetting() {
        ...
        bindingView.etMoney.setFilters(filters);
    }
...
//                    mWx = data.getWechat();
    ...
    private void loadSxf() {
        mWalletModel.getConfigValue(getActivity(), "sys_config_wyy", "bean_order_fee_rate", new RequestImpl() {
            ...
            public void loadSuccess(Object object) {
                ...
                if (bean != null && bean.getValue() != null) {
                    ...
                    bindingView.tv1.setText("挂售成功交易后，平台收取" + bean.getValue() + "%的手续费，未售卖成功金额自动返还");
                }
            }
     ...
     */
    private void doPost() {
        String title = bindingView.etTitle.getText().toString().trim();
        ...
        if (!StringUtils.isNoEmpty(money) || Double.parseDouble(money) <= 0) {
            ToastUtil.showShortToast("请输入正确的售卖金额");
            return;
        }
        if (payWay == -1) {
        ...
        mLoginModel.existPayPassword(getActivity(), new RequestImpl() {
            ...
            public void loadSuccess(Object object) {
                ...
                if (mIsExist.equals("1")) {
                    //发起支付 弹出输入密码框
                    showPayPwdPop(title, name, phone, wx, money);
                } else {
    ...
    private void showPayPwdPop(String title, String name, String phone, String wx, String money) {
        //弹出密码框
...
//                ToastUtil.showShortToast("输入完成回调");
                mGoldModel.addBeanOrderForm(getActivity(),
                        title,
                        passContent,
                        name, phone, wx, money,
                        payWay + "",
...
//                ToastUtil.showShortToast("忘记密码回调");
    ...
    private void selectPhoto() {
        ...
        startActivityForResult(BGAPhotoPickerActivity.newIntent(WoYaoShouMaiActivity.this, takePhotoDir,
                1,
