 ...
 * 待入账左边列表
 */
public class DrzListLeftFragment extends BaseFragment<CommonListBinding> {
    ...
    public static DrzListLeftFragment newInstance(String beginTime, String endTime) {
        DrzListLeftFragment fragment = new DrzListLeftFragment();
...
//        showContentView();
    ...
    private void requestData() {
        mModel.getMemberCapitalWaitLogList(getBaseActivity(), BusinessUtils.getBindAccountId(), "0", beginTime, endTime, mPage, HttpUtils.per_page_20, new RequestImpl() {
            @Override
