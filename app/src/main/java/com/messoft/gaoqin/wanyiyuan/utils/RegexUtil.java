...
//        String regex = "[1-9]\\d{13,16}[a-zA-Z0-9]{1}";
     ...
     * 152****4799
     */
    public static String setFourHideMobile(String mobile) {
     ...
     * 验证信用卡
     */
    public static boolean checkCreditedCard(String bankCard) {
        Pattern p = Pattern.compile("^((?:4\\d{3})|(?:5[1-5]\\d{2})|(?:6011)|(?:3[68]\\d{2})|(?:30[012345]\\d))[ -]?(\\d{4})[ -]?(\\d{4})[ -]?(\\d{4}|3[4,7]\\d{13})$");
     ...
     */
    public static String hideBlankCardNo(String cardNo) {
