...
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (starFillBitmap != null) {
            paint.setShader(new BitmapShader(this.starFillBitmap, BitmapShader.TileMode.CLAMP, BitmapShader.TileMode.CLAMP));
        }
    }
    ...
    public void setStarBarUnClickable(boolean isClickable) {
