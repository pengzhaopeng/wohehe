package com.messoft.gaoqin.wanyiyuan.view.edittext;
...
public class LimitWordsEdittext extends EditText {
    ...
    public LimitWordsEdittext(Context context, AttributeSet attrs) {
        ...
        int mDensity = (int) context.getResources().getDisplayMetrics().density;
        edit.setPadding(12 * mDensity, 6 * mDensity, 12 * mDensity, 6 * mDensity);
