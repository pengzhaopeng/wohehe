package com.messoft.gaoqin.wanyiyuan.view.scrollview;
...
/**
 * 粘性ScrollView，比如一个垂直方向的布局，依次摆放几个子View，当某一个子View滚到到顶端时候要停靠在顶部，
 * 悬停在顶部的位置不动。这很像联系人的pinned，假设联系人按照Z分组后，若滚动到顶部，Z就悬停靠在顶端不动，
 * 下面到的联系人继续滚到。当用户下拉时候，又恢复正常。
 *
 * 使用起来很简单，在xml布局中把某一个子View增加一个属性：android:tag="sticky"
 *
 *
